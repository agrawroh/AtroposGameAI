...
public class AtroposCircle {
     ...
     * @param leftDistance
     *            Left Distance of the circle.
     * @param rightDistance
     *            Right Distance of the circle.
     */
    public AtroposCircle(int height, int leftDistance, int rightDistance) {
    ...
    public AtroposCircle clone() {
        return new AtroposCircle(this.color, this.height, this.leftDistance,
                this.rightDistance);
    }
     ...
     *            New color for this.
     */
    public AtroposCircle color(int color) {
     ...
     * 
     * @param circle
     *            Circle we're comparing with.
     */
    public boolean adjacentTo(AtroposCircle circle) {
        return (((Math.abs(this.height - circle.height()) == 1) && (this.leftDistance == circle
                .leftDistance()))
                || ((Math.abs(this.leftDistance - circle.leftDistance()) == 1) && (this.height == circle
                        .height())) || ((Math
                .abs(this.height - circle.height()) == 1) && (this.rightDistance == circle
                .rightDistance())));
    }
    ...
    public boolean insideBoardOfSize(int size) {
        ...
        if (this.height == size || this.leftDistance == size
    ...
    public String getColorLocationString() {
        return "(" + this.color + ", " + this.height + ", " + this.leftDistance
                + ", " + this.rightDistance + ")";
    }
    ...
    public String toString(String indent) {
        String string = "";
        string += "Circle colored " + this.color + " at: (" + this.height
                + ", " + this.leftDistance + ", " + this.rightDistance + ").\n";
        return string;
    }
